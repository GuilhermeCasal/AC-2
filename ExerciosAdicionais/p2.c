...
int main(void){
    ...
    T2CONbits.TCKPS = 2; //(20000000 / (65535 * 120)) = 2,54 arredonda para 4
    PR2 = 41665;                //(20000000 / 4)/(120) -1 = 41665
    TMR2 = 0;
    T2CONbits.TON = 1;  
